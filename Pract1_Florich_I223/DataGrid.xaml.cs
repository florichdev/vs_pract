...
namespace Pract1_Florich_I223
{
    public partial class ProductDataGrid : Window
    {
        ...
        public ProductDataGrid(Users user)
        {
            ...
            roleService.SetCurrentUser(_currentUser);
            LoadUserData();
            LoadData();
        }
        ...
        {
            CheckUserClick checkUserClick = new CheckUserClick();
            bool isAuthorized = checkUserClick.CheckUserClicks(roleService.CurrentUser.Login, roleService.CurrentUser.Pass);
